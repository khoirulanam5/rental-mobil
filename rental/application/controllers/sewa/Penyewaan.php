...
class Penyewaan extends CI_Controller {
  ...
  public function getHistory(){
    $data['data'] = $this->db->query("select A.id_penyewaan, B.id_ketersediaan, DATE_FORMAT(A.tgl_pembelian, \"%d %b %Y <br> %H:%i\") tgl_pembelian, 
    DATE_FORMAT(A.tgl_penyewaan, \"%d %b %Y <br> %H:%i\") tgl_penyewaan,
    DATE_FORMAT(A.tgl_pengembalian, \"%d %b %Y <br> %H:%i\") tgl_pengembalian,
    B.tujuan, A.jumlah_sewa, C.kapasitas, D.nm_jenis_mobil, A.total_pembayaran, A.jaminan, E.status_validasi 
    from tb_penyewaan A
