...
<script>
  ...
  $(function () {
    ...
    $("#BTN_SAVE").click(function(){
      ...
      if(save_method == 'save') {
          urlPost = "<?= site_url('kategori/saveData') ?>"; // URL untuk save data baru
      }else{
          urlPost = "<?= site_url('kategori/updateData') ?>"; // URL untuk update data
  ...
  function REFRESH_DATA(){
    ...
    var tb_data = $("#tb_data").DataTable({
      ...
      "pageLength": 25,
      "ajax": {
          "url": "<?= site_url('kategori/getAllData') ?>", // URL untuk mengambil data
          "type": "GET"
      },
      "columns": [
          {
  ...
  function editData(data){
    ...
    $("#modal_add .modal-title").text('Edittt Data') // Mengubah judul modal
  ...
  function deleteData(id){
    ...
    urlPost = "<?= site_url('kategori/deleteData') ?>"; // URL untuk delete data
